            ...
            <div className="max-w-md w-full">
                ...
                <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 shadow-xl rounded-2xl p-8 border border-slate-100 dark:border-slate-800">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-3 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-900 dark:text-white font-bold py-4 rounded-lg border border-slate-200 dark:border-slate-700 transition-all shadow-sm"
                    >
